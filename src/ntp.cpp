...
void print_sntp_msg(const ntp::sntp_msg_t &msg) {
    ...
    Serial.println(invert_bits(msg.correction, 2));
    Serial.print("  Version: ");
    Serial.println(invert_bits(msg.version, 3));
    Serial.print("  Mode: ");
    switch (invert_bits(msg.mode, 3)) {
        case 0:
            ...
            break;
        case 1:
            Serial.println("Symmetric Active");
            break;
        case 2:
            Serial.println("Symmetric Passive");
            break;
        case 3:
        ...
        case 5:
            ...
            break;
        case 6:
            Serial.println("Reserved for NTP control message");
            break;
        case 7:
            Serial.println("Reserved for private use");
            break;
        default:
    ...
    Serial.println(ntohs(msg.root_delay.seconds) * 1000.0 +
                   ntohs(msg.root_delay.fraction) / 65536.0);

    Serial.print("  Root Dispersion: ");
    Serial.println(ntohs(msg.root_dispersion.seconds) * 1000.0 +
    ...
    Serial.println(timestamp_to_string(msg.reference_timestamp.seconds));
    Serial.print("  Originate Timestamp: ");
    Serial.println(timestamp_to_string(msg.originate_timestamp.seconds));
    Serial.print("  Receive Timestamp: ");
    Serial.println(timestamp_to_string(msg.receive_timestamp.seconds));
    Serial.print("  Transmit Timestamp: ");
    Serial.println(timestamp_to_string(msg.transmit_timestamp.seconds));
}
